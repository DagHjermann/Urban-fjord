---
title: "250_Nivabase_Urban_2022_addmeas"
format: html
---
...
dat_biota_nilu <- read_excel("Input_data/2022/Importmal_extern_biota_nilu_2022.xlsx")
dat_biota_ife <- read_excel("Input_data/2022/Importmal_extern_biota_ife_2022.xlsx")
...
* Bisphenol: set un-capital B
* Use d13C and d15N
* All metals except Hg: change UNIT to 'µg/g w.w.'  (and values correspondingly)   
* Extra changes  
    - Change BDE190 to BDE-190
    - Mn to MN
    - The long one (CAS 75768-65-9): Agreed on '4,4'-(Hexafluoroisopropylidene)diphenol benzyltriphenylphosphonium salt' (Teams chat with Anders 16.10.2023)     
