...
*NOTE: also uses Labware + Nivabase data from the corresponding scripts 300 and 400*  
...
dat_head1 <- read_excel("Input_data/2021/All_results MILFERSK2021_edit.xlsx", col_names = FALSE, n_max = 5)  
...
## 3. Compare sample IDs with TEXT_ID in the Labware data (scr. 300)   

### a. Labware data (scr. 300) 
...
dat_all <- read_excel("Input_data/2021/All_results MILFERSK2021_edit.xlsx", skip = 6, col_names = FALSE, col_types = "text")  
...
### Nivabase data (from script 400)  

```{r}

dir("Data", "400_dat_nb_biota_Milfersk_2021")

dat_nb_biota <- readRDS("Data/400_dat_nb_biota_Milfersk_2021_2023-06-06.rds")
